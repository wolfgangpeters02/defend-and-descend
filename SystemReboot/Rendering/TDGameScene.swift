...
class TDGameScene: SKScene {
    ...
    private var gameStartDelay: TimeInterval = BalanceConfig.TDRendering.gameStartDelay
    ...
    private var screenShakeCooldown: TimeInterval = BalanceConfig.TDRendering.screenShakeCooldown
    ...
    private let barrelRotationSpeed: CGFloat = BalanceConfig.TDRendering.barrelRotationSpeed
    ...
    private let maxAmbientParticles: Int = BalanceConfig.TDRendering.maxAmbientParticles
    private var visibleSectorIds: Set<String> = []  // For culling off-screen effects
    private var lastVisibilityUpdate: TimeInterval = 0
    private let visibilityUpdateInterval: TimeInterval = BalanceConfig.TDRendering.visibilityUpdateInterval
